...
contract TronUs {
	...
	uint256 constant public WITHDRAW_MIN_AMOUNT = 200 trx;
	...
	uint256[2] public directProfit = [400 trx, 1600 trx];
	uint256 public initBonusAmount = 100 trx;
	uint256 public initBonusLeft = 1000;

	address payable feeInvestRec0;
	address payable feeInvestRec1;
